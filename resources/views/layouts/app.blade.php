...
<body class="min-h-screen">
    ...
    <div class="fixed top-4 right-6 z-50">
        <button data-theme-toggle class="theme-toggle-btn" aria-label="Toggle dark mode">
            <svg data-sun-icon xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
            ...
            <svg data-moon-icon xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
