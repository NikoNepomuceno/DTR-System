    ...
    <div class="max-w-md w-full bg-white p-8 rounded-xl shadow-lg border">
        ...
        <form id="adminLoginForm">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    <input id="login-password" type="password" name="password" class="w-full border rounded px-3 py-2 pr-10 bg-white" required>
                    <button type="button" id="toggle-password" aria-label="Show password" class="absolute right-2 top-2 focus:outline-none">
                        <!-- Eye icon (visible by default) -->
                        <svg id="eye-icon" class="w-5 h-5 text-gray-400 hover:text-gray-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                        </svg>
                        <!-- Eye-off icon (hidden by default) -->
                        <svg id="eye-off-icon" class="w-5 h-5 text-gray-400 hover:text-gray-600 hidden" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <button type="submit" class="w-full bg-red-600 text-white py-2 rounded hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-400 active:bg-red-800 transition-colors duration-150">Login</button>
        </form>
